#Projeto_interface-funcionario-diretor-gerente.py
...
class  Funcionario:
    def __init__(self, nome, email, senha, telefone, salario, cargo, lotacao):
...
button_login = ctk.CTkButton(login_window, text="Login", command=open_inicio_funcionario)
